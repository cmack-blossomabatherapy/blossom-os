...
describe("/reports catalog is identical for every OS role", () => {
  ...
  it("primary reports bcba-performance and progress-reports have explicit drilldown paths", () => {
    ...
    expect(byId.get("progress-reports")?.drilldownPath).toBe("/reports/progress-reports");
  });
});

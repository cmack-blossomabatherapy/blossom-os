    ...
    Tables: {
      ...
      rbt_first_case: {
        Row: {
          ...
          lead_rbt_attending: boolean
          lead_rbt_id: string | null
          location_type: string | null
          readiness_acknowledged_at: string | null
          session_window_local: string | null
          start_date: string | null
          status: string
        ...
        Relationships: [
          {
            foreignKeyName: "rbt_first_case_assignment_id_fkey"
            columns: ["assignment_id"]
            isOneToOne: true
            referencedRelation: "rbt_client_assignments"
            referencedColumns: ["id"]
          },
          {
      ...
      rbt_first_session_bcba_followups: {
        Row: {
          additional_supervision_required: boolean
          bcba_id: string
          case_fit_concern: boolean
          clinical_direction_provided: boolean
          created_at: string
          employee_id: string
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "rbt_first_session_bcba_followups_first_case_id_fkey"
      ...
      rbt_first_session_checkins: {
        Row: {
          additional_support_note: string | null
          additional_support_requested: boolean
          centralreach_worked: boolean | null
          clarity: number | null
          confidence: number | null
          created_at: string
          employee_id: string
          family_concern: boolean
          family_concern_note: string | null
          first_case_id: string
          free_text: string | null
          id: string
          safety_concern: boolean
          safety_concern_note: string | null
          schedule_accuracy: number | null
          submitted_at: string
          support_received: number | null
        }
        Insert: {
          additional_support_note?: string | null
          additional_support_requested?: boolean
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "rbt_first_session_checkins_first_case_id_fkey"
            columns: ["first_case_id"]
            isOneToOne: false
            referencedRelation: "rbt_first_case"
            referencedColumns: ["id"]
      ...
      rbt_first_session_checklist_state: {
        Row: {
          done: boolean
          done_at: string | null
          employee_id: string
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "rbt_first_session_checklist_state_first_case_id_fkey"
            columns: ["first_case_id"]
            isOneToOne: false
            referencedRelation: "rbt_first_case"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "rbt_first_session_checklist_state_item_key_fkey"
            columns: ["item_key"]
            isOneToOne: false
            referencedRelation: "rbt_first_session_checklist_items"
            referencedColumns: ["key"]
          },
        ]
      }
      rbt_first_session_lead_evaluations: {
        Row: {
          caregiver_interaction: number | null
          created_at: string
          data_collection: number | null
          employee_id: string
          evaluated_at: string
          evaluator_id: string
          first_case_id: string
          ...
          notes: string | null
          pairing: number | null
          preference_assessment: number | null
          preparedness: number | null
          professional_conduct: number | null
          prompting: number | null
          routine_establishment: number | null
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "rbt_first_session_lead_evaluations_first_case_id_fkey"
            columns: ["first_case_id"]
            isOneToOne: false
            referencedRelation: "rbt_first_case"
            referencedColumns: ["id"]
      ...
      rbt_first_session_outcomes: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "rbt_first_session_outcomes_first_case_id_fkey"
            columns: ["first_case_id"]
            isOneToOne: false
            referencedRelation: "rbt_first_case"
            referencedColumns: ["id"]
      ...
      rbt_notification_deliveries: {
        ...
        Relationships: [
          {
            foreignKeyName: "rbt_notification_deliveries_event_id_fkey"
            columns: ["event_id"]
            isOneToOne: false
            referencedRelation: "rbt_notification_events"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "rbt_notification_deliveries_rule_id_fkey"
            columns: ["rule_id"]
            isOneToOne: false
            referencedRelation: "rbt_notification_rules"
            referencedColumns: ["id"]
          },
        ]
      }
      rbt_notification_events: {
        Row: {
          created_at: string
          dedupe_key: string | null
          deep_link: string | null
      ...
      rbt_support_audit: {
        ...
        Relationships: [
          {
            foreignKeyName: "rbt_support_audit_ticket_id_fkey"
            columns: ["ticket_id"]
            isOneToOne: false
            referencedRelation: "rbt_help_requests"
            referencedColumns: ["id"]
          },
        ]
      }
      rbt_support_categories: {
        Row: {
          active: boolean
          ai_advice_restricted: boolean
          allow_client_link: boolean
          created_at: string
      ...
      rbt_support_routing_rules: {
        Row: {
          ...
          match_escalation_min: number | null
          match_has_bcba: boolean | null
          match_has_client: boolean | null
          match_service_setting: string | null
          match_state: string | null
          match_subcategory: string | null
          match_time_of_day: string | null
          match_urgency: string | null
          name: string
          notify_role: string[] | null
          priority: number
          route_to_assigned_bcba: boolean
          route_to_employee_id: string | null
          route_to_rbt_support_rep: boolean
          route_to_role: string | null
          sla_minutes_override: number | null
          updated_at: string
        }
        Insert: {
          active?: boolean
      ...
      rbt_support_ticket_updates: {
        ...
        Relationships: [
          {
            foreignKeyName: "rbt_support_ticket_updates_ticket_id_fkey"
            columns: ["ticket_id"]
            isOneToOne: false
            referencedRelation: "rbt_help_requests"
            referencedColumns: ["id"]
      ...
      recruiting_background_checks: {
        ...
        Relationships: [
          {
            foreignKeyName: "recruiting_background_checks_candidate_id_fkey"
            columns: ["candidate_id"]
            isOneToOne: false
            referencedRelation: "recruiting_candidates"
            referencedColumns: ["id"]
      ...
      recruiting_candidates: {
        Row: {
          ...
          role: Database["public"]["Enums"]["recruiting_role"]
          source: string | null
          stage_entered_at: string
      ...
      recruiting_escalations: {
        ...
        Relationships: [
          {
            foreignKeyName: "recruiting_escalations_candidate_id_fkey"
            columns: ["candidate_id"]
            isOneToOne: false
            referencedRelation: "recruiting_candidates"
            referencedColumns: ["id"]
      ...
      recruiting_followups: {
        ...
        Relationships: [
          {
            foreignKeyName: "recruiting_followups_candidate_id_fkey"
            columns: ["candidate_id"]
            isOneToOne: false
            referencedRelation: "recruiting_candidates"
            referencedColumns: ["id"]
      ...
      recruiting_offers: {
        ...
        Relationships: [
          {
            foreignKeyName: "recruiting_offers_candidate_id_fkey"
            columns: ["candidate_id"]
            isOneToOne: false
            referencedRelation: "recruiting_candidates"
            referencedColumns: ["id"]
      ...
      recruiting_onboarding_tasks: {
        ...
        Relationships: [
          {
            foreignKeyName: "recruiting_onboarding_tasks_candidate_id_fkey"
            columns: ["candidate_id"]
            isOneToOne: false
            referencedRelation: "recruiting_candidates"
            referencedColumns: ["id"]
      ...
      recruiting_orientation_slots: {
        ...
        Relationships: [
          {
            foreignKeyName: "recruiting_orientation_slots_candidate_id_fkey"
            columns: ["candidate_id"]
            isOneToOne: false
            referencedRelation: "recruiting_candidates"
            referencedColumns: ["id"]
      ...
      recruiting_staffing_needs: {
        ...
        Relationships: [
          {
            foreignKeyName: "recruiting_staffing_needs_matched_candidate_id_fkey"

...
export interface SdAction { label: string; tone?: "primary" | "default" | "destructive" }
...
export const sdStatePerformance: SdReport = {
  kpis: [
    { id: "p1", label: "Active Clients", value: "83", rawValue: 83, change: "+6 MoM", trend: "up", hint: "Virginia" },
    { id: "p2", label: "Service Hours / Wk", value: "1,284", rawValue: 1284, change: "+4.2%", trend: "up" },
    { id: "p3", label: "Retention 90d", value: "94%", rawValue: 94, change: "+1pt", trend: "up" },
    { id: "p4", label: "Cancellation Rate", value: "8.1%", rawValue: 8.1, change: "-0.6pt", trend: "up" },
    { id: "p5", label: "Auth Risks", value: "9", rawValue: 9, change: "+2", trend: "down" },
    { id: "p6", label: "Recruiting Pipeline", value: "27", rawValue: 27, change: "+5", trend: "up" },
  ],
  insights: [
  ...
  actions: [
    { label: "Open Operations Brief", tone: "primary" },
    { label: "Schedule State Review" },
...
export const sdStaffing: SdReport = {
  kpis: [
    { id: "s1", label: "Unstaffed Clients", value: "3", rawValue: 3, change: "+1", trend: "down" },
    { id: "s2", label: "Partially Staffed", value: "7", rawValue: 7, change: "−2", trend: "up" },
    { id: "s3", label: "Overloaded BCBAs", value: "1", rawValue: 1, change: "0", trend: "neutral" },
    { id: "s4", label: "Underutilized RBTs", value: "2", rawValue: 2, change: "+1", trend: "down" },
    { id: "s5", label: "Urgent Staffing", value: "5", rawValue: 5, change: "+2", trend: "down" },
    { id: "s6", label: "Avg Time to Staff", value: "4.1d", rawValue: 4.1, change: "−0.3d", trend: "up" },
  ],
  insights: [
  ...
  actions: [
    { label: "Open Scheduling", tone: "primary" },
...
export const sdBcbaPerf: SdReport = {
  kpis: [
    { id: "b1", label: "Avg Supervision %", value: "84%", rawValue: 84, change: "+2pt", trend: "up" },
    { id: "b2", label: "PR Completion", value: "91%", rawValue: 91, change: "−2pt", trend: "down" },
    { id: "b3", label: "Avg Caseload", value: "11.8", rawValue: 11.8, change: "+0.4", trend: "neutral" },
    { id: "b4", label: "Service Hours / BCBA", value: "34.7", rawValue: 34.7, change: "+1.1", trend: "up" },
    { id: "b5", label: "Cancellations", value: "7.2%", rawValue: 7.2, change: "−0.4pt", trend: "up" },
    { id: "b6", label: "Parent Training", value: "78%", rawValue: 78, change: "+5pt", trend: "up" },
  ],
  insights: [
  ...
  actions: [
    { label: "Open BCBA Workspace", tone: "primary" },
    { label: "Send Coaching Note" },
...
export const sdAuthPrRisk: SdReport = {
  kpis: [
    { id: "a1", label: "Auths < 30d", value: "9", rawValue: 9, change: "+3", trend: "down" },
    { id: "a2", label: "Overdue PRs", value: "6", rawValue: 6, change: "+2", trend: "down" },
    { id: "a3", label: "Missing 97155", value: "4", rawValue: 4, change: "−1", trend: "up" },
    { id: "a4", label: "Missing 97156", value: "11", rawValue: 11, change: "−3", trend: "up" },
    { id: "a5", label: "QA Delays > 5d", value: "5", rawValue: 5, change: "+1", trend: "down" },
    { id: "a6", label: "Reassessment Risk", value: "3", rawValue: 3, change: "0", trend: "neutral" },
  ],
  insights: [
  ...
  actions: [
    { label: "Open Auth Workqueue", tone: "primary" },
    { label: "Open QA Queue" },
    { label: "Notify BCBAs" },
  ],
};
...
export const sdRecruiting: SdReport = {
  kpis: [
    { id: "r1", label: "Active Applicants", value: "62", rawValue: 62, change: "+8", trend: "up" },
    { id: "r2", label: "BCBA Pipeline", value: "9", rawValue: 9, change: "+2", trend: "up" },
    { id: "r3", label: "RBT Pipeline", value: "53", rawValue: 53, change: "+6", trend: "up" },
    { id: "r4", label: "Interviews / Wk", value: "21", rawValue: 21, change: "+3", trend: "up" },
    { id: "r5", label: "Onboarding", value: "12", rawValue: 12, change: "−1", trend: "neutral" },
    { id: "r6", label: "Orientation Done", value: "84%", rawValue: 84, change: "+4pt", trend: "up" },
  ],
  insights: [
  ...
  actions: [
    { label: "Open Recruiting", tone: "primary" },
...
export const sdGrowth: SdReport = {
  kpis: [
    { id: "g1", label: "New Clients (MTD)", value: "14", rawValue: 14, change: "+3", trend: "up" },
    { id: "g2", label: "Discharged", value: "3", rawValue: 3, change: "−1", trend: "up" },
    { id: "g3", label: "Flaked", value: "2", rawValue: 2, change: "0", trend: "neutral" },
    { id: "g4", label: "Waitlist", value: "11", rawValue: 11, change: "+4", trend: "down" },
    { id: "g5", label: "Net Growth", value: "+9", rawValue: 9, change: "+2", trend: "up" },
    { id: "g6", label: "Hours Growth", value: "+5.4%", rawValue: 5.4, change: "+1.2pt", trend: "up" },
  ],
  insights: [
  ...
  actions: [
    { label: "Open Growth Plan", tone: "primary" },
    { label: "Open Waitlist" },
...
export const sdScheduling: SdReport = {
  kpis: [
    { id: "h1", label: "Session Completion", value: "92%", rawValue: 92, change: "+1pt", trend: "up" },
    { id: "h2", label: "Cancellations", value: "8.1%", rawValue: 8.1, change: "−0.4pt", trend: "up" },
    { id: "h3", label: "No-Shows", value: "2.3%", rawValue: 2.3, change: "−0.2pt", trend: "up" },
    { id: "h4", label: "Uncovered Sessions", value: "11", rawValue: 11, change: "+3", trend: "down" },
    { id: "h5", label: "Scheduling Conflicts", value: "4", rawValue: 4, change: "0", trend: "neutral" },
    { id: "h6", label: "Fill Rate", value: "88%", rawValue: 88, change: "+2pt", trend: "up" },
  ],
  insights: [
...
export const sdParentTraining: SdReport = {
  kpis: [
    { id: "pt1", label: "Authorized 97156 Hrs", value: "412", rawValue: 412, change: "+24", trend: "up" },
    { id: "pt2", label: "Delivered", value: "318", rawValue: 318, change: "+38", trend: "up" },
    { id: "pt3", label: "Utilization", value: "77%", rawValue: 77, change: "+6pt", trend: "up" },
    { id: "pt4", label: "Clients w/o PT this Mo", value: "11", rawValue: 11, change: "−3", trend: "up" },
    { id: "pt5", label: "Below Target BCBAs", value: "2", rawValue: 2, change: "−1", trend: "up" },
    { id: "pt6", label: "Net Gain MoM", value: "+9pt", rawValue: 9, change: "vs March", trend: "up" },
  ],
  insights: [
  ...
  actions: [
    { label: "Open 97156 List", tone: "primary" },
    { label: "Notify Below-Target BCBAs" },
  ],
};
...
export const sdSupervision: SdReport = {
  kpis: [
    { id: "v1", label: "97153 Hours", value: "928", rawValue: 928, change: "+34", trend: "up" },
    { id: "v2", label: "97155 Hours", value: "212", rawValue: 212, change: "+12", trend: "up" },
    { id: "v3", label: "Avg Supervision %", value: "11.6%", rawValue: 11.6, change: "+0.4pt", trend: "up" },
    { id: "v4", label: "Below Target Clients", value: "6", rawValue: 6, change: "−2", trend: "up" },
    { id: "v5", label: "BCBA Supervision Load", value: "42 hrs/wk", rawValue: 42, change: "+3", trend: "neutral" },
    { id: "v6", label: "Clients > 15%", value: "9", rawValue: 9, change: "+2", trend: "up" },
  ],
  insights: [
  ...
  actions: [
    { label: "Open Below-Target Clients", tone: "primary" },
...
export const sdBottlenecks: SdReport = {
  kpis: [
    { id: "k1", label: "Intake Stuck", value: "4", rawValue: 4, change: "+1", trend: "down" },
    { id: "k2", label: "Auth Stuck", value: "6", rawValue: 6, change: "0", trend: "neutral" },
    { id: "k3", label: "Onboarding Stuck", value: "3", rawValue: 3, change: "−1", trend: "up" },
    { id: "k4", label: "Recruiting Stuck", value: "2", rawValue: 2, change: "0", trend: "neutral" },
    { id: "k5", label: "Staffing Stuck", value: "8", rawValue: 8, change: "+2", trend: "down" },
    { id: "k6", label: "QA Delays", value: "5", rawValue: 5, change: "+1", trend: "down" },
  ],
  insights: [
  ...
  actions: [
    { label: "Open Workflows", tone: "primary" },
    { label: "Escalate" },
  ],
};
...
export const sdComparison: SdReport = {
  ...
  actions: [
    { label: "Open State Benchmarks", tone: "primary" },
...
export const sdActionReport: SdReport = {
  ...
  actions: [
    { label: "Open Action Inbox", tone: "primary" },
    { label: "Assign Owners" },
    { label: "Export PDF" },
  ],
};
...
export const mockLeads: Lead[] = [
  buildLead({ id: "L-2042", childName: "Emma Thompson", parentName: "Jennifer Thompson", phone: "(404) 555-0142", email: "jthompson@email.com", state: "GA", source: "Website", status: "New Lead", owner: "Sarah M.", priority: "Hot", childAge: "3y 2m", createdAt: "2025-04-15T14:00:00Z", lastContacted: null, daysInStage: 0, nextAction: "Make first contact within the hour", nextTaskDue: "2025-04-15", lastActivity: "Website inquiry created", payor: "BCBS", coverageType: "PPO", paymentPlanNeeded: false, insurance: "BCBS of Georgia", insuranceType: "PPO" }),
  buildLead({ id: "L-2041", childName: "Aiden Carter", parentName: "Brittany Carter", phone: "(919) 555-0198", email: "bcarter@email.com", state: "NC", source: "Referral", status: "In Contact", owner: "James R.", priority: "Warm", childAge: "4y 8m", createdAt: "2025-04-13T09:00:00Z", lastContacted: "2025-04-14T10:30:00Z", daysInStage: 2, nextAction: "Send intake form after benefits call", nextTaskDue: "2025-04-16", lastActivity: "SMS sent", payor: "Aetna", coverageType: "HMO", paymentPlanNeeded: false, insurance: "Aetna", insuranceType: "HMO" }),
  buildLead({ id: "L-2040", childName: "Sofia Garcia", parentName: "Maria Garcia", phone: "(770) 555-0167", email: "mgarcia@email.com", state: "GA", source: "Phone", status: "Form Received", owner: "Sarah M.", priority: "Hot", childAge: "2y 11m", formStatus: "Completed", consentStatus: "Sent", formReviewStatus: "Pending", createdAt: "2025-04-10T08:00:00Z", lastContacted: "2025-04-13T15:00:00Z", daysInStage: 1, nextAction: "Review form and send VOB", nextTaskDue: "2025-04-15", lastActivity: "Form completed", payor: "United", coverageType: "PPO", paymentPlanNeeded: false, insurance: "United Healthcare", insuranceType: "PPO", documents: [{ name: "Intake Form", type: "PandaDoc", uploadedAt: "2025-04-12" }, { name: "Insurance Card Front", type: "Image", uploadedAt: "2025-04-12" }] }),
  buildLead({ id: "L-2039", childName: "Liam Brooks", parentName: "Tasha Brooks", phone: "(615) 555-0134", email: "tbrooks@email.com", state: "TN", source: "Website", status: "Sent to VOB", owner: "Maya P.", priority: "Warm", childAge: "5y 1m", formStatus: "Completed", consentStatus: "Completed", vobStatus: "Sent", formReviewStatus: "Complete", createdAt: "2025-04-08T10:00:00Z", lastContacted: "2025-04-12T11:00:00Z", daysInStage: 3, nextAction: "Follow up on VOB response", nextTaskDue: "2025-04-16", lastActivity: "VOB sent to insurance", payor: "Cigna", coverageType: "PPO", paymentPlanNeeded: true, insurance: "Cigna", insuranceType: "PPO", documents: [{ name: "Intake Form", type: "PandaDoc", uploadedAt: "2025-04-11" }, { name: "Consent Forms", type: "PDF", uploadedAt: "2025-04-11" }, { name: "Insurance Card", type: "Image", uploadedAt: "2025-04-11" }] }),
  buildLead({ id: "L-2038", childName: "Olivia Brown", parentName: "Mark Brown", phone: "(678) 555-0189", email: "mbrown@email.com", state: "GA", source: "Facebook", status: "Missing Information", owner: "Sarah M.", priority: "Warm", childAge: "3y 7m", formStatus: "Sent", consentStatus: "Not Sent", formReviewStatus: "Missing Information", createdAt: "2025-04-07T12:00:00Z", lastContacted: "2025-04-11T09:00:00Z", daysInStage: 5, nextAction: "Collect diagnosis page and insurance back", nextTaskDue: "2025-04-15", lastActivity: "Missing info flagged", payor: "BCBS", coverageType: "EPO", paymentPlanNeeded: false, insurance: "BCBS of Georgia", insuranceType: "EPO", documents: [{ name: "Intake Form Incomplete", type: "PandaDoc", uploadedAt: "2025-04-10" }] }),
  buildLead({ id: "L-2037", childName: "Noah Williams", parentName: "Keisha Williams", phone: "(804) 555-0156", email: "kwilliams@email.com", state: "VA", source: "Organic", status: "VOB Completed", owner: "James R.", priority: "Hot", childAge: "4y 0m", formStatus: "Completed", consentStatus: "Completed", vobStatus: "Approved", formReviewStatus: "Complete", createdAt: "2025-04-05T07:00:00Z", lastContacted: "2025-04-14T16:00:00Z", daysInStage: 1, nextAction: "Move to Client Pipeline", nextTaskDue: "2025-04-15", lastActivity: "VOB completed", payor: "Virginia Medicaid", coverageType: "Managed", paymentPlanNeeded: false, insurance: "Virginia Medicaid", insuranceType: "Managed Care", vobFile: { name: "VOB_Williams.pdf", uploadedAt: "2025-04-14" }, documents: [{ name: "Intake Form", type: "PandaDoc", uploadedAt: "2025-04-12" }, { name: "Consent Forms", type: "PDF", uploadedAt: "2025-04-12" }, { name: "VOB Report", type: "PDF", uploadedAt: "2025-04-14" }] }),
  buildLead({ id: "L-2036", childName: "Ava Martin", parentName: "Carlos Martin", phone: "(704) 555-0178", email: "cmartin@email.com", state: "NC", source: "Ads", status: "Can't Reach", owner: "Maya P.", priority: "Cold", childAge: "3y 4m", createdAt: "2025-04-03T11:00:00Z", lastContacted: "2025-04-10T14:00:00Z", daysInStage: 8, nextAction: "Final contact attempt", nextTaskDue: "2025-04-16", lastActivity: "Call attempt three voicemail", payor: "Tricare", coverageType: "Prime", paymentPlanNeeded: false, insurance: "Tricare East", insuranceType: "Prime" }),
  buildLead({ id: "L-2035", childName: "Ethan Davis", parentName: "Lauren Davis", phone: "(410) 555-0123", email: "ldavis@email.com", state: "MD", source: "Website", status: "New Lead", owner: "", priority: "Hot", childAge: "2y 6m", createdAt: "2025-04-15T08:00:00Z", lastContacted: null, daysInStage: 0, nextAction: "Assign owner and call parent", nextTaskDue: "2025-04-15", lastActivity: "Lead created", payor: "CareFirst", coverageType: "PPO", paymentPlanNeeded: false, insurance: "CareFirst BCBS", insuranceType: "PPO" }),
  buildLead({ id: "L-2034", childName: "Mia Johnson", parentName: "David Johnson", phone: "(615) 555-0145", email: "djohnson@email.com", state: "TN", source: "Ads", status: "Sent Form", owner: "Sarah M.", priority: "Warm", childAge: "3y 9m", formStatus: "Sent", createdAt: "2025-04-09T13:00:00Z", lastContacted: "2025-04-11T10:00:00Z", daysInStage: 4, nextAction: "Follow up on unopened form", nextTaskDue: "2025-04-15", lastActivity: "Form sent", payor: "Aetna", coverageType: "PPO", paymentPlanNeeded: false, insurance: "Aetna", insuranceType: "PPO" }),
  buildLead({ id: "L-2033", childName: "Lucas Wilson", parentName: "Amanda Wilson", phone: "(757) 555-0199", email: "awilson@email.com", state: "VA", source: "Referral", status: "Needs DX", owner: "James R.", priority: "Warm", childAge: "4y 3m", formStatus: "Completed", consentStatus: "Completed", formReviewStatus: "Complete", createdAt: "2025-04-06T15:00:00Z", lastContacted: "2025-04-13T09:00:00Z", daysInStage: 3, nextAction: "Wait for DX from pediatrician", nextTaskDue: "2025-04-18", lastActivity: "DX request sent", payor: "United", coverageType: "HMO", paymentPlanNeeded: true, insurance: "United Healthcare", insuranceType: "HMO", documents: [{ name: "Intake Form", type: "PandaDoc", uploadedAt: "2025-04-10" }, { name: "Consent Forms", type: "PDF", uploadedAt: "2025-04-10" }] }),
  buildLead({ id: "L-2032", childName: "Isabella Lee", parentName: "Grace Lee", phone: "(301) 555-0112", email: "glee@email.com", state: "MD", source: "Website", status: "New Lead", owner: "Maya P.", priority: "Hot", childAge: "2y 1m", createdAt: "2025-04-15T11:00:00Z", lastContacted: null, daysInStage: 0, nextAction: "Make first contact", nextTaskDue: "2025-04-15", lastActivity: "Lead created", payor: "Cigna", coverageType: "PPO", paymentPlanNeeded: false, insurance: "Cigna", insuranceType: "PPO" }),
  buildLead({ id: "L-2031", childName: "Jackson Moore", parentName: "Tiffany Moore", phone: "(919) 555-0176", email: "tmoore@email.com", state: "NC", source: "Phone", status: "Sent Form", owner: "James R.", priority: "Warm", childAge: "5y 5m", formStatus: "Viewed", createdAt: "2025-04-08T09:00:00Z", lastContacted: "2025-04-10T16:00:00Z", daysInStage: 6, nextAction: "Follow up form viewed but not completed", nextTaskDue: "2025-04-15", lastActivity: "Form viewed by parent", payor: "Cigna", coverageType: "PPO", paymentPlanNeeded: false, insurance: "Cigna", insuranceType: "PPO" }),
  buildLead({ id: "L-2030", childName: "Charlotte Kim", parentName: "Helen Kim", phone: "(470) 555-0211", email: "hkim@email.com", state: "GA", source: "Facebook", status: "Can Not Submit Auth", owner: "Sarah M.", priority: "Hot", childAge: "3y 0m", formStatus: "Completed", consentStatus: "Completed", vobStatus: "Issue", formReviewStatus: "Missing Information", createdAt: "2025-04-04T10:00:00Z", lastContacted: "2025-04-13T11:00:00Z", daysInStage: 4, nextAction: "Collect missing documentation", nextTaskDue: "2025-04-17", lastActivity: "Auth blocked missing docs", payor: "Anthem", coverageType: "PPO", paymentPlanNeeded: false, insurance: "Anthem", insuranceType: "PPO", documents: [{ name: "Intake Form", type: "PandaDoc", uploadedAt: "2025-04-08" }] }),
  buildLead({ id: "L-2029", childName: "Mason Rivera", parentName: "Diana Rivera", phone: "(615) 555-0287", email: "drivera@email.com", state: "TN", source: "Phone", status: "Non-Qualified", owner: "Maya P.", priority: "Cold", childAge: "9y 2m", createdAt: "2025-03-28T09:00:00Z", lastContacted: "2025-04-09T14:00:00Z", daysInStage: 9, nextAction: "Archive after parent notice", nextTaskDue: null, lastActivity: "Age range mismatch", payor: "Cigna", coverageType: "HMO", paymentPlanNeeded: false, insurance: "Cigna", insuranceType: "HMO", notQualifiedReason: "Out of age range" }),
];

...
const CATEGORIES: Category[] = [
  ...
  },
  {
    ...
    resources: [
      ...
      { id: "o8", title: "Ask Blossom AI Guide",            type: "Guide", description: "How to get clean operational answers from AI.", minutes: 3, updated: "1w ago", tags: ["os","ai"] },
            ...
            <section className="rounded-2xl border border-border/70 bg-gradient-to-br from-primary/[0.04] via-card to-card p-6 md:p-8">
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1 space-y-4">
                  <div>
                    <h2 className="text-xl font-medium tracking-tight">Ask Blossom AI</h2>

      ...
      <div className="px-6 md:px-10 py-10 max-w-7xl mx-auto">
        ...
        <div className="grid gap-6 lg:grid-cols-[1fr_300px]">
          ...
          <aside className="space-y-6">
            <section>
              <h3 className="text-[11px] uppercase tracking-wider text-muted-foreground mb-2 px-1">Ask Blossom AI</h3>
              <Card className="p-3">
        ...
        <div className="fixed inset-0 z-50 flex">
          ...
          <div className="w-full max-w-xl h-full bg-card border-l border-border/70 overflow-y-auto">
            ...
            <div className="p-5 space-y-5">
              ...
              <Link to="/os/hr/employee-support" className="inline-flex items-center gap-1.5 text-[12px] text-primary hover:opacity-80">

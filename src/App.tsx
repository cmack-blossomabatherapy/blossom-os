...
import IntakeAssignments from "./pages/os/intake/IntakeAssignments";
import IntakeConfiguration from "./pages/os/intake/IntakeConfiguration";
...
import RbtCourseDetail from "./pages/rbt/app/training/RbtCourseDetail";
import RbtWelcome from "./pages/rbt/app/welcome/RbtWelcome";
            ...
            <ClientsProvider>
              <JourneyOverridesProvider>
                ...
                <Route element={<ProtectedRoute><OSOutlet /></ProtectedRoute>}>
                  ...
                  <Route path="/state-director/resources" element={<PermissionRoute allowedRoles={["admin", "state_director", "assistant_state_director", "regional_state_director", "state_va", "exec", "executive", "coo", "ops_manager", "director_of_operations", "operations_manager", "operations_leadership", "business_development", "intake_lead", "recruiting_lead", "scheduling_lead", "staffing_lead", "clinical_director", "bcba", "case_manager", "qa", "qa_team", "qa_director", "authorization_manager", "training_manager"]}><OSStateDirectorResources /></PermissionRoute>} />
                  <Route path="/assistant-state-director/resources" element={<PermissionRoute allowedRoles={["admin", "assistant_state_director", "state_director", "regional_state_director", "state_va", "exec", "executive", "coo", "ops_manager", "director_of_operations", "operations_manager", "operations_leadership", "intake_lead", "recruiting_lead", "scheduling_lead", "staffing_lead", "clinical_director", "case_manager", "qa", "qa_team", "qa_director", "authorization_manager", "training_manager"]}><OSAssistantStateDirectorResources /></PermissionRoute>} />
                  <Route path="/intake-coordinator" element={<OSIntakeCoordinator />} />
                  <Route path="/auth-coordinator" element={<OSAuthCoordinator />} />
                  <Route path="/auth-workspace" element={<PermissionRoute allowedRoles={["admin", "authorization_coordinator", "authorization_manager", "authorization_team", "authorizations", "exec", "executive", "coo", "ops_manager", "director_of_operations", "operations_manager", "operations_leadership", "state_director", "assistant_state_director", "regional_state_director", "qa", "qa_team", "qa_director", "clinical_director"]}><OSAuthWorkspace /></PermissionRoute>} />
                 ...
                 <Route path="/recruiting/apploi" element={<OSRecruitingApploi />} />
                  ...
                  <Route path="/qa-workspace" element={<PermissionRoute allowedRoles={["admin", "qa", "qa_team", "qa_director", "qa_specialist", "clinical_director", "state_director", "assistant_state_director", "regional_state_director", "exec", "executive", "coo", "ops_manager", "director_of_operations", "operations_manager", "operations_leadership"]}><OSQAWorkspace /></PermissionRoute>} />
                  <Route path="/qa-queue" element={<PermissionRoute allowedRoles={["admin", "qa", "qa_team", "qa_director", "qa_specialist", "clinical_director", "state_director", "assistant_state_director", "regional_state_director", "exec", "executive", "coo", "ops_manager", "director_of_operations", "operations_manager", "operations_leadership"]}><OSQAQueue /></PermissionRoute>} />
                  <Route path="/qa/board" element={<PermissionRoute allowedRoles={["admin", "qa", "qa_team", "qa_director", "qa_specialist", "clinical_director", "state_director", "assistant_state_director", "regional_state_director", "exec", "executive", "coo", "ops_manager", "director_of_operations", "operations_manager", "operations_leadership"]}><OSQAReviewBoard /></PermissionRoute>} />
                  <Route path="/qa-clients" element={<PermissionRoute allowedRoles={["admin", "qa", "qa_team", "qa_director", "qa_specialist", "clinical_director", "state_director", "assistant_state_director", "regional_state_director", "exec", "executive", "coo", "ops_manager", "director_of_operations", "operations_manager", "operations_leadership"]}><OSQAClients /></PermissionRoute>} />
                  <Route path="/authorization-reviews" element={<PermissionRoute allowedRoles={["admin", "qa", "qa_team", "qa_director", "qa_specialist", "clinical_director", "state_director", "assistant_state_director", "regional_state_director", "authorization_coordinator", "authorization_manager", "exec", "executive", "coo", "ops_manager", "director_of_operations", "operations_manager", "operations_leadership"]}><OSQAAuthReviews /></PermissionRoute>} />
                  ...
                  <Route path="/assigned-bcbas" element={<PermissionRoute allowedRoles={["admin","super_admin","qa", "qa_team","qa_director","qa_specialist","clinical_director","operations_leadership","state_director","assistant_state_director","regional_state_director"]}><OSQABCBAs /></PermissionRoute>} />
                  <Route path="/supervision-visibility" element={<PermissionRoute allowedRoles={["admin","super_admin","qa", "qa_team","qa_director","qa_specialist","clinical_director","operations_leadership","state_director","assistant_state_director","regional_state_director","behavioral_support"]}><OSQASupervision /></PermissionRoute>} />
                  <Route path="/qa-messages" element={<PermissionRoute allowedRoles={["admin", "qa", "qa_team", "qa_director", "qa_specialist", "clinical_director", "operations_leadership"]}><OSQAMessages /></PermissionRoute>} />
                  <Route path="/escalations-followups" element={<PermissionRoute allowedRoles={["admin","super_admin","qa", "qa_team","qa_director","qa_specialist","clinical_director","operations_leadership","state_director","assistant_state_director","regional_state_director","behavioral_support"]}><OSQAEscalations /></PermissionRoute>} />
                  ...
                  <Route path="/behavioral-support" element={<PermissionRoute allowedRoles={["admin", "behavioral_support", "bcba", "clinical_director", "qa", "qa_team", "qa_director", "qa_specialist", "operations_leadership", "state_director", "assistant_state_director", "regional_state_director"]}><BehavioralSupportDashboard /></PermissionRoute>} />
                  <Route path="/behavioral-support/crisis-support" element={<PermissionRoute allowedRoles={["admin", "behavioral_support", "bcba", "clinical_director", "qa", "qa_team", "qa_director", "qa_specialist", "operations_leadership", "state_director", "assistant_state_director", "regional_state_director"]}><BehavioralSupportCrisisSupport /></PermissionRoute>} />
                  <Route path="/behavioral-support/escalations" element={<PermissionRoute allowedRoles={["admin", "behavioral_support", "bcba", "clinical_director", "qa", "qa_team", "qa_director", "qa_specialist", "operations_leadership", "state_director", "assistant_state_director", "regional_state_director"]}><BehavioralSupportEscalations /></PermissionRoute>} />
                  <Route path="/behavioral-support/support-plans" element={<PermissionRoute allowedRoles={["admin", "behavioral_support", "bcba", "clinical_director", "qa", "qa_team", "qa_director", "qa_specialist", "operations_leadership", "state_director", "assistant_state_director", "regional_state_director"]}><BehavioralSupportPlans /></PermissionRoute>} />
                  <Route path="/behavioral-support/follow-ups" element={<PermissionRoute allowedRoles={["admin", "behavioral_support", "bcba", "clinical_director", "qa", "qa_team", "qa_director", "qa_specialist", "operations_leadership", "state_director", "assistant_state_director", "regional_state_director"]}><BehavioralSupportFollowUps /></PermissionRoute>} />
                  <Route path="/behavioral-support/supervision-visibility" element={<PermissionRoute allowedRoles={["admin", "behavioral_support", "bcba", "clinical_director", "qa", "qa_team", "qa_director", "qa_specialist", "operations_leadership", "state_director", "assistant_state_director", "regional_state_director"]}><BehavioralSupportSupervisionVisibility /></PermissionRoute>} />
                  <Route path="/behavioral-support/evaluations" element={<PermissionRoute allowedRoles={["admin", "behavioral_support", "bcba", "clinical_director", "qa", "qa_team", "qa_director", "qa_specialist", "operations_leadership", "state_director", "assistant_state_director", "regional_state_director"]}><BehavioralSupportEvaluations /></PermissionRoute>} />
                  ...
                  <Route path="/rbt" element={<RbtLegacyRoute appPath="home"><PermissionRoute allowedRoles={["rbt","registered_behavior_technician","lead_rbt","trainer","trainer_rbt","floater_lead_rbt","admin","super_admin","bcba","clinical_director","training_admin","hr","hr_admin","operations_leadership","state_director","assistant_state_director"]}><OSRBT /></PermissionRoute></RbtLegacyRoute>} />
                  <Route path="/rbt/my-day" element={<RbtLegacyRoute appPath="home"><PermissionRoute allowedRoles={["rbt","registered_behavior_technician","lead_rbt","trainer","trainer_rbt","floater_lead_rbt","admin","super_admin","bcba","clinical_director","training_admin"]}><OSRBTMyDay /></PermissionRoute></RbtLegacyRoute>} />
                  <Route path="/rbt/training-academy" element={<RbtLegacyRoute appPath="learn"><PermissionRoute allowedRoles={["rbt","registered_behavior_technician","lead_rbt","trainer","trainer_rbt","floater_lead_rbt","admin","super_admin","bcba","clinical_director","training_admin"]}><OSRBTTrainingAcademy /></PermissionRoute></RbtLegacyRoute>} />
                  ...
                  <Route path="/rbt/supervision" element={<RbtLegacyRoute appPath="supervision"><PermissionRoute allowedRoles={["rbt","registered_behavior_technician","lead_rbt","trainer","trainer_rbt","floater_lead_rbt","admin","super_admin","bcba","clinical_director","qa", "qa_team","qa_director"]}><OSRBTSupervision /></PermissionRoute></RbtLegacyRoute>} />
                  ...
                  <Route path="/authorizations" element={<PermissionRoute allowedRoles={["admin", "authorization_coordinator", "authorization_manager", "authorization_team", "authorizations", "state_director", "assistant_state_director", "exec", "executive", "coo", "ops_manager", "director_of_operations", "operations_manager", "operations_leadership", "qa", "qa_team", "qa_director", "qa_specialist", "bcba", "clinical_director"]}><AuthorizationsRouter /></PermissionRoute>} />
                 ...
                 <Route path="/ops/scheduling" element={<Navigate to="/scheduling-workspace?bucket=coverage_risk" replace />} />
                  <Route path="/ops/staffing" element={<PermissionRoute allowedRoles={[...OPERATIONS_AND_STATE_ROUTE_ROLES, "assistant_state_director", "staffing", "staffing_lead", "staffing_coordinator"]}><OSStaffingWorkspace /></PermissionRoute>} />
                  ...
                  <Route path="/ops/family-staffing-preferences" element={<PermissionRoute allowedRoles={[...OPERATIONS_AND_STATE_ROUTE_ROLES, "assistant_state_director", "staffing", "staffing_lead", "staffing_coordinator"]}><Navigate to="/ops/staffing?tab=preferences" replace /></PermissionRoute>} />
                ...
                <Route element={<ProtectedRoute><AppLayout /></ProtectedRoute>}>
                  ...
                  <Route path="/admin/login-vault" element={<AdminRoute><Navigate to="/user-management" replace /></AdminRoute>} />

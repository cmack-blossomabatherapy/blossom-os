              ...
              <JourneyOverridesProvider>
                ...
                <Route element={<ProtectedRoute><OSOutlet /></ProtectedRoute>}>
                 ...
                 <Route path="/ops/scheduling" element={<Navigate to="/scheduling-workspace?bucket=coverage_risk" replace />} />
                  <Route path="/ops/staffing" element={<PermissionRoute allowedRoles={["admin", "staffing", "staffing_lead", "staffing_coordinator", "staffing_team", "state_director", "assistant_state_director", "operations_leadership", "ops_manager", "exec"]}><OSStaffingWorkspace /></PermissionRoute>} />
                  ...
                  <Route path="/ops/family-staffing-preferences" element={<PermissionRoute allowedRoles={["admin", "staffing", "staffing_lead", "staffing_coordinator", "staffing_team", "state_director", "assistant_state_director", "operations_leadership", "ops_manager", "exec"]}><Navigate to="/ops/staffing?tab=preferences" replace /></PermissionRoute>} />

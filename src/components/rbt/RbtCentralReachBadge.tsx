...
/** Honest CentralReach sync status pill for RBT workflow records. */
export function RbtCentralReachSummaryBadge({
  pendingCount,
  className,
}: {
  pendingCount: number;
...
export function RbtCentralReachStatusBadge({ status, className }: { status?: string | null; className?: string }) {

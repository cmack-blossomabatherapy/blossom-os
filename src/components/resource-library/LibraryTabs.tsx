...
import {
  BookOpen, User, Building2, GraduationCap, FileText, PlayCircle, ShieldAlert, Inbox, Users, ShieldCheck, CalendarClock, UsersRound, BadgeCheck,
} from "lucide-react";
...
const TABS = [
  ...
  { to: "/resource-library/credentialing", label: "Credentialing", icon: BadgeCheck },

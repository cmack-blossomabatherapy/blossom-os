import { Search, Filter, Plus, ListTodo, Sparkles, Users, Map } from "lucide-react";
import { Input } from "@/components/ui/input";
import { Button } from "@/components/ui/button";
import { cn } from "@/lib/utils";

export type StaffingViewMode = "queue" | "matching" | "directory" | "capacity";

interface Props {
  viewMode: StaffingViewMode;
  onViewModeChange: (m: StaffingViewMode) => void;
  activeView: string;
...
const savedViews = [
  { id: "staffing-needed", label: "Staffing Needed" },
  { id: "restaffing", label: "Restaffing Needed" },
  { id: "available-rbts", label: "Available RBTs" },
  { id: "fully-staffed", label: "Fully Staffed Clients" },
  { id: "overloaded", label: "Overloaded Staff" },
  { id: "my", label: "My Assignments" },
];

const viewModes: { id: StaffingViewMode; label: string; icon: typeof ListTodo }[] = [
  { id: "queue", label: "Queue", icon: ListTodo },
  { id: "matching", label: "Matching", icon: Sparkles },
  { id: "directory", label: "Directory", icon: Users },
  { id: "capacity", label: "Capacity Map", icon: Map },
];

export function StaffingControlBar({

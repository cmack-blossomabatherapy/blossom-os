        ...
        {resources.map((r) => {
          ...
          return (
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="group rounded-xl border border-border/60 p-4 hover:border-primary/40 hover:shadow-md transition-all bg-gradient-to-br from-background to-muted/20"
            >

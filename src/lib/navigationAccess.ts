...
const dashboardPreviewSection: NavigationPreviewSection = {
  ...
  items: [
    ...
    { label: "Staffing Dashboard", path: "/staffing", perm: "dashboard.view", superAdminOnly: true },
...
const sectionRoutePrefixes: Record<string, string[]> = {
  ...
  Operate: ["/clients", "/leads", "/authorizations", "/scheduling", "/staffing", "/qa", "/recruiting/workspace", "/clinics"],
  Pipeline: ["/pipeline"],
  "Phone System": ["/phone"],

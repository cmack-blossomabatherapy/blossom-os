...
export const TRAINING_PATHS: TrainingPath[] = [
  ...
  { slug: "intake",                   title: "Intake Training",            audience: "Intake Team",         category: "Department",  description: "Lead capture, VOB process, intake packets, and family handoff to clinical.",            estimatedHours: 5,  lessonCount: 12, icon: ClipboardCheck },
  ...
  { slug: "authorizations",           title: "Authorizations Training",    audience: "Authorizations Team", category: "Department",  description: "Payer rules, auth submissions, denials, and renewal cadence.",                          estimatedHours: 5,  lessonCount: 12, icon: ShieldCheck },
  { slug: "scheduling",               title: "Scheduling Training",        audience: "Scheduling Team",     category: "Department",  description: "Session scheduling, cancellations, recovery, and coverage workflows.",                  estimatedHours: 4,  lessonCount: 10, icon: Calendar },
  { slug: "staffing",                 title: "Staffing Training",          audience: "Staffing Team",       category: "Department",  description: "Pairings, coverage planning, and staff matching with family preferences.",              estimatedHours: 4,  lessonCount: 10, icon: Users },

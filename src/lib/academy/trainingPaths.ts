...
export const TRAINING_PATHS: TrainingPath[] = [
  ...
  { slug: "case-manager",             title: "Case Manager Onboarding",    audience: "Clinical Services / Case Manager", category: "Role", description: "Current-state 4-week onboarding: role boundaries, current systems (CentralReach / current trackers / clinical documents / Outlook / Teams), client lifecycle, family communication, assessment / treatment plan / parent training / progress report visibility, services on pause, discharges, clinical escalation, and cross-department handoffs.", estimatedHours: 20, lessonCount: 80, icon: HeartHandshake },
  { slug: "behavioral-support",       title: "Behavioral Support Onboarding", audience: "Behavioral Support / Clinical Support", category: "Role", description: "Current-state 4-week onboarding: role boundaries, current systems (CentralReach / clinical documents / current trackers / Outlook / Teams), behavior plan and treatment plan awareness, RBT and family support within boundaries, parent training visibility, clinical documentation awareness, services on pause, discharge awareness, clinical escalation, and cross-department handoffs.", estimatedHours: 20, lessonCount: 80, icon: HeartHandshake },
  ...
  { slug: "state-director",           title: "State Director Onboarding",  audience: "State Director / State Operations Leadership", category: "Role", description: "Current-state 4-week onboarding: role boundaries, current systems (Monday / current trackers, CentralReach visibility, Outlook / Teams, phone, state notes), state health, hours serviced, department accountability, state growth, local relationships / referral / BD support, intake and recruiting / staffing visibility, Assistant State Director and VA leadership, state escalation management, state-specific knowledge, weekly rhythm and scorecard, and executive communication quality.", estimatedHours: 20, lessonCount: 80, icon: Building2 },
  { slug: "assistant-state-director", title: "Assistant State Director Onboarding", audience: "Assistant State Director / State Operations Support", category: "Role", description: "Current-state 4-week onboarding: role boundaries, current systems (Monday / current trackers, CentralReach visibility, Outlook / Teams, phone, state notes), state health, department boundaries, intake / recruiting support in growing states, state growth coordination, client pipeline follow-up, VA task oversight, state escalation management, state-specific knowledge, end-of-day cleanup, and communication quality.", estimatedHours: 20, lessonCount: 80, icon: UserCheck },
  ...
  { slug: "marketing-and-business-development", title: "Marketing & Business Development Onboarding", audience: "Marketing / Business Development Team", category: "Department", description: "Current-state 4-week onboarding: role boundaries, current systems (CTM / call-source, Facebook / Google Ads, LeadTrap, Mailchimp, referral partner tracker, event checklists), campaigns, referral partnerships, boots-on-the-ground BD, and clean handoffs to Intake.", estimatedHours: 20, lessonCount: 60, icon: Megaphone },

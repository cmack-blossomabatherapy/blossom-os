...
export interface AcademyResourceScope {
  ...
  sourceKind?: "rbt" | "bcba" | "academyData" | "intake" | "recruiting" | "authorizations" | "scheduling" | "staffing" | "hr" | "credentialing" | "qa" | "case-manager" | "behavioral-support" | "assistant-state-director" | "state-director" | "marketing-bd";

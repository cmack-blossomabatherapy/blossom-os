...
export const STARTER_RBT_RESOURCES: RBTResource[] = [
  ...
  { id: "lib-ws-01", title: "Pairing Power-Up Bingo",                type: "Worksheet", url: "/library/rbt/worksheets/pairing-power-up-bingo.pdf",     description: "Bingo-style worksheet for building rapport with new clients.",            category: "worksheets", tags: ["pairing"],            moduleIds: [...MODS_PRACTICE], seeded: true },
  ...
  { id: "lib-ws-17", title: "Operational Definition Lab",            type: "Worksheet", url: "/library/rbt/worksheets/operational-definition-lab.pdf", description: "Write operational definitions that hold up in supervision.",              category: "worksheets", tags: ["definitions"],        moduleIds: [...MODS_PRACTICE], seeded: true },
  ...
  { id: "lib-ws-10", title: "ABC Crossword",                         type: "Worksheet", url: "/library/rbt/worksheets/abc-crossword.pdf",              description: "Crossword review of antecedent–behavior–consequence data.",               category: "worksheets", tags: ["abc", "data"],        moduleIds: [...MODS_PRACTICE], seeded: true },
  ...
  { id: "lib-ws-14", title: "Scope Check",                           type: "Worksheet", url: "/library/rbt/worksheets/scope-check.pdf",                description: "Stay inside the RBT scope — practice scenarios.",                         category: "worksheets", tags: ["scope"],              moduleIds: [...MODS_PRACTICE], seeded: true },
  ...
  { id: "lib-ws-11", title: "Spot the Ethical Violation",            type: "Worksheet", url: "/library/rbt/worksheets/spot-ethical-violation.pdf",     description: "Apply the RBT ethics code — spot the violation in each scenario.",        category: "worksheets", tags: ["ethics"],             moduleIds: [...MODS_PRACTICE], seeded: true },
  { id: "lib-ws-20", title: "BCBA vs RBT Text Message",              type: "Worksheet", url: "/library/rbt/worksheets/bcba-vs-rbt-text.pdf",           description: "Practice professional, in-scope text replies with BCBAs.",                category: "worksheets", tags: ["scope", "communication"], moduleIds: [...MODS_PRACTICE], seeded: true },

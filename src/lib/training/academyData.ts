...
const SEED_TRAININGS: Training[] = [
  ...
  },
  {
    ...
    resources: [{ id: "r1", type: "Link", title: "Referral Queue", url: "/intake/referral-queue" }],
  },
  {
    id: "intake-referral-queue-workflow",
    title: "Referral Queue Workflow",
    description: "Triage, assign, and contact new referrals before they go cold.",
    type: "Workflow", estimatedMinutes: 16, required: true,
    category: "role", department: "intake", owner: "Intake Lead", lastUpdated: "2026-06-23",
    sopMarkdown: "## Daily flow\n1. Open Referral Queue.\n2. Sort by oldest unassigned.\n3. Assign owner.\n4. First contact within 1 business hour.\n5. Log result.",
    checklist: [{ id: "c1", item: "Run the queue solo for one day", required: true }],
    resources: [{ id: "r1", type: "Link", title: "Referral Queue", url: "/intake/referral-queue" }],
  },
  {
...
const SEED_JOURNEYS: RoleJourney[] = [
  { id: "j-intake", role: "intake_coordinator", title: "Intake Coordinator Journey", tagline: "From first phone call to a happy active client.", icon: "ClipboardList", tone: "lilac", moduleIds: [
    ...
    "intake-referral-queue-workflow",
    "intake-workflow",

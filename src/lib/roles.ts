...
export const ROLE_META: RoleMeta[] = [
  ...
  { key: "behavioral_support", label: "Behavioral Support", group: "Service", description: "Clinical support for BCBAs, RBTs, and families — owns escalations, crisis triage, support plans, and follow-ups.", permissionLevel: "Edit Scoped", scope: "Behavioral support workflows, crisis/escalation triage, support plans, BCBA/RBT clinical support visibility, follow-ups, evaluations visibility, training, resources, and shared reports.", owners: ["Behavioral Support Team"], owns: ["Behavior escalation triage", "Clinical support planning", "Crisis support workflow", "BCBA/RBT behavioral guidance follow-up", "Support plan task tracking", "Behavioral Support activity log"], can: ["Create and update Behavioral Support escalations", "Create support plans", "Assign follow-ups", "Log support notes", "View supervision and parent-training signals", "View relevant evaluations", "View the shared Reports page", "Access Training Academy and Resource Library"], cannot: ["Manage payroll", "Manage HR-sensitive employee data", "Manage billing/finance", "Override system permissions", "Replace CentralReach as the EMR"] },
  ...
  // Client Pipeline
  { key: "intake_lead", label: "Director of Intake", group: "Pipeline", description: "Owns the intake queue, conversions, and handoffs to VOB.", permissionLevel: "Full Module Control", scope: "Intake department", owners: [], owns: ["Intake queue", "Lead conversion"], can: ["Manage intake team", "Approve exceptions", "Oversee VOB handoff"] },

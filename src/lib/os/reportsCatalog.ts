...
export const REPORTS: ReportDef[] = [
  ...
  { id: "qa-auth-utilization", title: "Authorization Utilization", description: "Upload a CentralReach authorization export and instantly identify utilization risks, expiring auths, exhausted auths, and client authorization health.", category: "qa", visibleTo: ["super_admin", "operations_leadership", "qa_team", "authorization_coordinator", "state_director", "assistant_state_director", "clinical_director", "behavioral_support"], type: "dashboard", owner: "QA / Compliance", lastUpdated: "On upload", popularity: 94, featured: true, aiInsight: "Upload one CR auth export - instantly see utilization risks and expirations by client.", kpiPreviews: [{ label: "Avg Util %", value: "Auto", trend: "up" }, { label: "Exp <30d", value: "Auto", trend: "down" }, { label: "Over-util", value: "Auto", trend: "down" }], sparkline: [42, 48, 55, 60, 65, 68, 72, 76, 80], tags: ["Authorization", "Utilization", "Expiration", "Risk"] },

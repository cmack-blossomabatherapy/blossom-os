...
export const REPORTS: ReportDef[] = [
  ...
  { id: "sd-bcba-performance", title: "BCBA Performance", description: "Supervision, PRs, caseload, hours, retention — operational, not punitive.", category: "clinical", visibleTo: ["super_admin", "operations_leadership", "state_director", "qa_team"], type: "dashboard", owner: "State Director", lastUpdated: "Live", popularity: 94, featured: true, aiInsight: "3 PRs overdue > 7 days across the state.", kpiPreviews: [{ label: "Supervision", value: "84%", delta: "+2pt", trend: "up" }, { label: "PR Done", value: "91%", delta: "−2pt", trend: "down" }], sparkline: [78, 80, 82, 84, 85, 86, 87, 88], tags: ["BCBA"] },
  { id: "sd-auth-pr-risk", title: "Auth / PR Risk", description: "Expiring auths, overdue PRs, missing supervision and 97156 — actionable.", category: "qa", visibleTo: ["super_admin", "operations_leadership", "state_director", "qa_team"], type: "dashboard", owner: "State Director", lastUpdated: "Live", popularity: 92, featured: true, aiInsight: "2 Anthem auths expire inside 10 days — start packets today.", kpiPreviews: [{ label: "Auths <30d", value: "9", trend: "down" }, { label: "Overdue PRs", value: "6", trend: "down" }], sparkline: [40, 42, 46, 48, 52, 55, 60, 64], tags: ["Risk", "Compliance"] },

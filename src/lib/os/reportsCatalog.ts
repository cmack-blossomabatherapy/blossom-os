...
export const REPORTS: ReportDef[] = [
  ...
  { id: "qa-cancellation", title: "Session Cancellation Dashboard", description: "Upload a CentralReach Scheduling Cancellation export and instantly analyze cancellation trends, reasons, provider impacts and client attendance risks.", category: "qa", visibleTo: ["super_admin", "operations_leadership", "qa_team", "state_director", "assistant_state_director", "scheduling_team", "behavioral_support"], type: "dashboard", owner: "QA / Compliance", lastUpdated: "On upload", popularity: 93, featured: true, aiInsight: "Upload one CR cancellation export - instantly see top reasons, provider impact and at-risk clients.", kpiPreviews: [{ label: "Total cancels", value: "Auto", trend: "down" }, { label: "Provider %", value: "Auto", trend: "down" }, { label: "No shows", value: "Auto", trend: "down" }], sparkline: [60, 58, 62, 55, 50, 48, 52, 46, 42], tags: ["Cancellation", "Attendance", "No Show", "Scheduling"] },

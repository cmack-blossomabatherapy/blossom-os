...
export const REPORTS: ReportDef[] = [
  ...
  // QA
  { id: "qa-performance", title: "QA Performance", description: "QA turnaround, queue size, and revenue impact of delays.", category: "qa", visibleTo: ["super_admin", "operations_leadership", "qa_team", "bcba", "clinical_director"], type: "dashboard", owner: "QA / Compliance", lastUpdated: "3h ago", popularity: 88, aiInsight: "QA turnaround 3.1d (-1d). Watch: 2 plans stuck >7 days.", kpiPreviews: [{ label: "Turnaround", value: "3.1d", delta: "-1d", trend: "up" }, { label: "Queue", value: "15", delta: "+2", trend: "down" }, { label: "Stuck >5d", value: "12%", delta: "-3pt", trend: "up" }], sparkline: [72, 68, 65, 60, 58, 54, 52, 50, 48], tags: ["QA", "Bottleneck"], detailView: "qa" },
  { id: "qa-supervision-pt", title: "Supervision & Parent Training", description: "Upload a CentralReach billing CSV to instantly review 97153 supervision ratios and 97156 parent training completion by client.", category: "qa", visibleTo: ["super_admin", "operations_leadership", "qa_team", "bcba", "clinical_director"], type: "dashboard", owner: "QA / Compliance", lastUpdated: "On upload", popularity: 95, featured: true, aiInsight: "Upload one CR billing export - instantly see supervision % and 97156 gaps by client.", kpiPreviews: [{ label: "97153 hrs", value: "Auto", trend: "up" }, { label: "Supervision %", value: "Auto", trend: "up" }, { label: "97156 gaps", value: "Auto", trend: "down" }], sparkline: [40, 48, 52, 60, 58, 64, 70, 74, 78], tags: ["97153", "97155", "97156", "Supervision", "Parent Training"] },
  { id: "qa-auth-utilization", title: "Authorization Utilization", description: "Upload a CentralReach authorization export and instantly identify utilization risks, expiring auths, exhausted auths, and client authorization health.", category: "qa", visibleTo: ["super_admin", "operations_leadership", "qa_team", "authorization_coordinator", "state_director", "clinical_director"], type: "dashboard", owner: "QA / Compliance", lastUpdated: "On upload", popularity: 94, featured: true, aiInsight: "Upload one CR auth export - instantly see utilization risks and expirations by client.", kpiPreviews: [{ label: "Avg Util %", value: "Auto", trend: "up" }, { label: "Exp <30d", value: "Auto", trend: "down" }, { label: "Over-util", value: "Auto", trend: "down" }], sparkline: [42, 48, 55, 60, 65, 68, 72, 76, 80], tags: ["Authorization", "Utilization", "Expiration", "Risk"] },

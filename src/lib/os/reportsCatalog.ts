...
export const REPORTS: ReportDef[] = [
  ...
  // QA
  { id: "qa-performance", title: "QA Performance", description: "QA turnaround, queue size, and revenue impact of delays.", category: "qa", visibleTo: ["super_admin", "operations_leadership", "qa_team", "bcba"], type: "dashboard", owner: "QA / Compliance", lastUpdated: "3h ago", popularity: 88, aiInsight: "QA turnaround 3.1d (-1d). Watch: 2 plans stuck >7 days.", kpiPreviews: [{ label: "Turnaround", value: "3.1d", delta: "-1d", trend: "up" }, { label: "Queue", value: "15", delta: "+2", trend: "down" }, { label: "Stuck >5d", value: "12%", delta: "-3pt", trend: "up" }], sparkline: [72, 68, 65, 60, 58, 54, 52, 50, 48], tags: ["QA", "Bottleneck"], detailView: "qa" },
  { id: "qa-supervision-pt", title: "Supervision & Parent Training", description: "Upload a CentralReach billing CSV to instantly review 97153 supervision ratios and 97156 parent training completion by client.", category: "qa", visibleTo: ["super_admin", "operations_leadership", "qa_team", "bcba"], type: "dashboard", owner: "QA / Compliance", lastUpdated: "On upload", popularity: 95, featured: true, aiInsight: "Upload one CR billing export — instantly see supervision % and 97156 gaps by client.", kpiPreviews: [{ label: "97153 hrs", value: "Auto", trend: "up" }, { label: "Supervision %", value: "Auto", trend: "up" }, { label: "97156 gaps", value: "Auto", trend: "down" }], sparkline: [40, 48, 52, 60, 58, 64, 70, 74, 78], tags: ["97153", "97155", "97156", "Supervision", "Parent Training"] },
  { id: "qa-auth-utilization", title: "Authorization Utilization", description: "Upload a CentralReach authorization export and instantly identify utilization risks, expiring auths, exhausted auths, and client authorization health.", category: "qa", visibleTo: ["super_admin", "operations_leadership", "qa_team", "authorization_coordinator", "state_director"], type: "dashboard", owner: "QA / Compliance", lastUpdated: "On upload", popularity: 94, featured: true, aiInsight: "Upload one CR auth export — instantly see utilization risks and expirations by client.", kpiPreviews: [{ label: "Avg Util %", value: "Auto", trend: "up" }, { label: "Exp <30d", value: "Auto", trend: "down" }, { label: "Over-util", value: "Auto", trend: "down" }], sparkline: [42, 48, 55, 60, 65, 68, 72, 76, 80], tags: ["Authorization", "Utilization", "Expiration", "Risk"] },
  { id: "qa-cancellation", title: "Session Cancellation Dashboard", description: "Upload a CentralReach Scheduling Cancellation export and instantly analyze cancellation trends, reasons, provider impacts and client attendance risks.", category: "qa", visibleTo: ["super_admin", "operations_leadership", "qa_team", "state_director", "scheduling_team"], type: "dashboard", owner: "QA / Compliance", lastUpdated: "On upload", popularity: 93, featured: true, aiInsight: "Upload one CR cancellation export — instantly see top reasons, provider impact and at-risk clients.", kpiPreviews: [{ label: "Total cancels", value: "Auto", trend: "down" }, { label: "Provider %", value: "Auto", trend: "down" }, { label: "No shows", value: "Auto", trend: "down" }], sparkline: [60, 58, 62, 55, 50, 48, 52, 46, 42], tags: ["Cancellation", "Attendance", "No Show", "Scheduling"] },
  ...
  { id: "bcba-productivity-report", title: "BCBA Productivity Report", description: "Monthly breakdown of each BCBA's productivity, supervision (97155), parent training (97156), caseload, RBT support and minimum-hours compliance. Upload a CR billing / service export; exports to CSV, Excel and PDF.", category: "clinical", visibleTo: ["super_admin", "executive_leadership", "operations_leadership", "state_director", "hr_team", "qa_team", "bcba", "behavioral_support"], type: "table", owner: "Operations", lastUpdated: "On upload", popularity: 88, featured: true, aiInsight: "Monthly per-BCBA productivity with client and RBT drilldowns.", kpiPreviews: [{ label: "BCBAs", value: "Auto", trend: "up" }, { label: "Avg caseload", value: "Auto", trend: "up" }, { label: "Below min", value: "Auto", trend: "down" }], sparkline: [40, 48, 52, 58, 62, 66, 70, 74, 78], tags: ["BCBA", "Productivity", "Monthly", "97155", "97156", "Standard"] },
  { id: "bcba-productivity-report-v2", title: "BCBA Productivity Report V2", description: "Single billing-report upload. Historical BCBA Assignment History drives ownership — every hour (including 97153) is credited to the BCBA who owned the client on the date of service.", category: "clinical", visibleTo: ["super_admin", "executive_leadership", "operations_leadership", "state_director", "hr_team", "qa_team", "bcba", "behavioral_support"], type: "dashboard", owner: "Operations", lastUpdated: "On upload", popularity: 92, featured: true, aiInsight: "Accurate historical attribution — no auth matching, no current-label drift.", kpiPreviews: [{ label: "Total Hours", value: "Auto", trend: "up" }, { label: "97153 Hours", value: "Auto", trend: "up" }, { label: "Active BCBAs", value: "Auto", trend: "up" }], sparkline: [42, 50, 56, 62, 68, 72, 76, 82, 88], tags: ["BCBA", "Productivity", "Historical Ownership", "97153", "Featured", "V2"] },
  { id: "bcba-productivity-report-v3", title: "BCBA Productivity Report V3", description: "One billing upload. Permanent BCBA Assignment History is the source of truth for ownership at DOS. Preserves both ClientId and normalized name matching, surfaces unassigned hours and dropped rows in a validation panel.", category: "clinical", visibleTo: ["super_admin", "executive_leadership", "operations_leadership", "state_director", "hr_team", "qa_team", "bcba", "behavioral_support"], type: "dashboard", owner: "Operations", lastUpdated: "On upload", popularity: 95, featured: true, aiInsight: "Historical ownership. No auth uploads. No seeded data. Unassigned rows are visible, not silently dropped.", kpiPreviews: [{ label: "Total Hours", value: "Auto", trend: "up" }, { label: "97153 Hours", value: "Auto", trend: "up" }, { label: "Unassigned", value: "Auto", trend: "down" }], sparkline: [44, 52, 60, 66, 72, 78, 82, 86, 92], tags: ["BCBA", "Productivity", "Historical Ownership", "97153", "Featured", "V3"] },
  ...
  { id: "sd-parent-training", title: "Parent Training 97156", description: "Which clients are missing parent training, by BCBA and month.", category: "qa", visibleTo: ["super_admin", "operations_leadership", "state_director", "qa_team", "bcba"], type: "summary", owner: "State Director", lastUpdated: "Live", popularity: 82, aiInsight: "Utilization up 6 points — coaching impact visible.", kpiPreviews: [{ label: "Utilization", value: "77%", delta: "+6pt", trend: "up" }], sparkline: [55, 60, 62, 66, 70, 72, 74, 77], tags: ["97156", "Compliance"] },
  { id: "sd-supervision", title: "Supervision Report", description: "97153 vs 97155 hours, % supervision, below-target clients, BCBA load.", category: "qa", visibleTo: ["super_admin", "operations_leadership", "state_director", "qa_team", "bcba"], type: "dashboard", owner: "State Director", lastUpdated: "Live", popularity: 80, aiInsight: "6 clients below the 10% supervision threshold this period.", kpiPreviews: [{ label: "Avg %", value: "11.6%", delta: "+0.4pt", trend: "up" }], sparkline: [62, 64, 66, 68, 70, 72, 74], tags: ["Supervision"] },

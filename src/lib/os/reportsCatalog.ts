...
export const REPORTS: ReportDef[] = [
  ...
  { id: "cred-status", title: "Credentialing Status", description: "Live snapshot of every provider/payer credentialing record by status, state, and follow-up cadence.", category: "operations", visibleTo: ["super_admin", "credentialing_team", "credentialing_lead", "operations_leadership", "executive_leadership"], type: "dashboard", owner: "Credentialing", lastUpdated: "Live", popularity: 88, aiInsight: "Setup ready - data populated as credentialing records are entered.", sparkline: [40, 44, 50, 54, 58, 62, 68, 72], tags: ["Credentialing", "Status"] },
  { id: "cred-bcba-coverage", title: "BCBA Credential Coverage", description: "BCBA coverage by payer and state - where can each BCBA bill today?", category: "clinical", visibleTo: ["super_admin", "credentialing_team", "credentialing_lead", "operations_leadership", "executive_leadership"], type: "summary", owner: "Credentialing", lastUpdated: "Live", popularity: 84, aiInsight: "Surfaces BCBAs without payer coverage as soon as records exist.", sparkline: [50, 54, 58, 62, 66, 70, 74, 78], tags: ["BCBA", "Coverage"] },
  { id: "cred-uncredentialed-bcbas", title: "Uncredentialed BCBAs", description: "BCBAs missing payer credentialing or actively blocked - the daily working list.", category: "operations", visibleTo: ["super_admin", "credentialing_team", "credentialing_lead", "operations_leadership", "executive_leadership"], type: "table", owner: "Credentialing", lastUpdated: "Live", popularity: 90, aiInsight: "Drives the Uncredentialed BCBAs workspace.", sparkline: [30, 32, 28, 26, 24, 22, 20, 18], tags: ["Risk", "BCBA"] },
  { id: "cred-expiring", title: "Expiring Credentials", description: "Credentials expiring within 30/60/90 days and the renewal owners.", category: "operations", visibleTo: ["super_admin", "credentialing_team", "credentialing_lead", "operations_leadership", "executive_leadership"], type: "table", owner: "Credentialing", lastUpdated: "Live", popularity: 87, aiInsight: "Sub-15 day expirations are flagged as critical in the workspace.", sparkline: [10, 12, 14, 16, 18, 20, 22, 24], tags: ["Expiring", "Renewal"] },
  { id: "cred-payer-matrix", title: "Payer Credentialing Matrix", description: "Payer x state matrix: credentialed, pending, blocked, expiring - growth and risk in one view.", category: "leadership", visibleTo: ["super_admin", "credentialing_team", "credentialing_lead", "operations_leadership", "executive_leadership"], type: "dashboard", owner: "Credentialing", lastUpdated: "Live", popularity: 82, aiInsight: "Identify payers blocking growth or authorizations.", sparkline: [40, 44, 48, 52, 56, 60, 64, 68], tags: ["Payer", "Matrix"] },

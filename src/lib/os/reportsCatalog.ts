...
export const REPORTS: ReportDef[] = [
  ...
  { id: "cred-payer-matrix", title: "Payer Credentialing Matrix", description: "Payer x state matrix: credentialed, pending, blocked, expiring - growth and risk in one view.", category: "leadership", visibleTo: ["super_admin", "credentialing_team", "credentialing_lead", "operations_leadership", "executive_leadership"], type: "dashboard", owner: "Credentialing", lastUpdated: "Live", popularity: 82, aiInsight: "Identify payers blocking growth or authorizations.", sparkline: [40, 44, 48, 52, 56, 60, 64, 68], tags: ["Payer", "Matrix"], drilldownPath: "/credentialing/insurance?from=reports&report=cred-payer-matrix" },

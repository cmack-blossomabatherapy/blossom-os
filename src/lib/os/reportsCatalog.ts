...
export const REPORTS: ReportDef[] = [
   ...
   * PRIMARY_REPORT_IDS below). Eleven are shared with every Blossom OS
  ...
  },
  {
    ...
    featured: true,
    aiInsight:
      "Per-client authorization risk, remaining hours, expirations, and the renewals that need confirmation.",
    kpiPreviews: [
  ...
  { id: "bcba-productivity-report", title: "BCBA Productivity Report", description: "Legacy BCBA productivity report - available to all authenticated users for now (business rule).", category: "clinical", visibleTo: "all", type: "dashboard", owner: "Operations", lastUpdated: "Live from Data Hub", popularity: 90, aiInsight: "Kept broadly available while V3 becomes the source of truth.", sparkline: [40, 48, 54, 60, 66, 72, 78, 82], tags: ["BCBA", "Productivity", "Legacy"] },
  ...
  // Scheduling
  { id: "scheduling-perf", title: "Scheduling & Staffing", description: "Time-to-schedule, fill rate, and capacity gaps by state.", category: "scheduling", visibleTo: ["super_admin", "scheduling_team", "state_director", "assistant_state_director", "operations_leadership"], type: "dashboard", owner: "Scheduling", lastUpdated: "2h ago", popularity: 79, featured: true, aiInsight: "Georgia capacity gap widened to 62 hrs - recruit lever.", kpiPreviews: [{ label: "Fill rate", value: "78%", delta: "+5pt", trend: "up" }, { label: "Time to schedule", value: "2.6d", delta: "-0.4d", trend: "up" }], sparkline: [55, 60, 64, 68, 70, 74, 76, 78], tags: ["Capacity"], detailView: "scheduling" },
  { id: "session-completion", title: "Session Completion", description: "Cancellations, no-shows, and delivered hours.", category: "scheduling", visibleTo: ["super_admin", "scheduling_team", "state_director", "assistant_state_director", "bcba"], type: "trend", owner: "Scheduling", lastUpdated: "Today", popularity: 68, aiInsight: "Cancellation rate steady at 8% - within tolerance.", sparkline: [78, 80, 82, 81, 83, 85, 84, 86], tags: ["Sessions"] },

  // Recruiting
  { id: "recruiting-pipeline", title: "Recruiting Pipeline", description: "Applicants, time-to-hire, and source quality.", category: "recruiting", visibleTo: ["super_admin", "recruiting_team", "hr_team", "state_director", "assistant_state_director"], type: "dashboard", owner: "Recruiting", lastUpdated: "1h ago", popularity: 72, aiInsight: "Indeed source: 2x conversion vs ZipRecruiter.", sparkline: [40, 44, 48, 52, 55, 58, 60, 64], tags: ["Hiring"] },
  ...
  { id: "sd-bcba-performance", title: "BCBA Performance", description: "Supervision, PRs, caseload, hours, retention - operational, not punitive.", category: "clinical", visibleTo: ["super_admin", "operations_leadership", "state_director", "assistant_state_director"], type: "dashboard", owner: "State Director", lastUpdated: "Live", popularity: 94, featured: true, aiInsight: "3 PRs overdue > 7 days across the state.", kpiPreviews: [{ label: "Supervision", value: "84%", delta: "+2pt", trend: "up" }, { label: "PR Done", value: "91%", delta: "-2pt", trend: "down" }], sparkline: [78, 80, 82, 84, 85, 86, 87, 88], tags: ["BCBA"] },
  { id: "sd-auth-pr-risk", title: "Auth / PR Risk", description: "Expiring auths, overdue PRs, missing supervision and 97156 - actionable.", category: "qa", visibleTo: ["super_admin", "operations_leadership", "state_director", "assistant_state_director"], type: "dashboard", owner: "State Director", lastUpdated: "Live", popularity: 92, featured: true, aiInsight: "2 Anthem auths expire inside 10 days - start packets today.", kpiPreviews: [{ label: "Auths <30d", value: "9", trend: "down" }, { label: "Overdue PRs", value: "6", trend: "down" }], sparkline: [40, 42, 46, 48, 52, 55, 60, 64], tags: ["Risk", "Compliance"] },
  { id: "sd-recruiting", title: "Recruiting Pipeline", description: "Can we support growth? Applicants, interviews, onboarding, credentialing.", category: "recruiting", visibleTo: ["super_admin", "operations_leadership", "state_director", "assistant_state_director", "recruiting_team"], type: "dashboard", owner: "State Director", lastUpdated: "Live", popularity: 88, aiInsight: "BCBA pipeline can cover next 30 days of starts.", kpiPreviews: [{ label: "Applicants", value: "62", delta: "+8", trend: "up" }, { label: "Onboarding", value: "12", trend: "neutral" }], sparkline: [40, 44, 48, 52, 56, 60, 62, 64], tags: ["Growth", "Hiring"] },
  { id: "sd-growth", title: "Client Growth", description: "New, discharged, flaked, waitlist, hours - growth over time.", category: "state", visibleTo: ["super_admin", "operations_leadership", "state_director", "assistant_state_director", "executive_leadership"], type: "trend", owner: "State Director", lastUpdated: "Live", popularity: 86, aiInsight: "Richmond region driving 60% of new starts this month.", kpiPreviews: [{ label: "New MTD", value: "14", delta: "+3", trend: "up" }, { label: "Net", value: "+9", trend: "up" }], sparkline: [50, 56, 62, 66, 70, 74, 78, 82], tags: ["Growth"] },
  { id: "sd-scheduling", title: "Scheduling Health", description: "Completion, cancellations, no-shows, uncovered sessions, fill rate.", category: "scheduling", visibleTo: ["super_admin", "operations_leadership", "state_director", "assistant_state_director", "scheduling_team"], type: "dashboard", owner: "State Director", lastUpdated: "Live", popularity: 84, aiInsight: "Tuesday afternoons in Richmond - 6 uncovered sessions pattern.", kpiPreviews: [{ label: "Completion", value: "92%", trend: "up" }, { label: "Fill Rate", value: "88%", trend: "up" }], sparkline: [78, 80, 82, 84, 85, 86, 88], tags: ["Sessions"] },
  { id: "sd-parent-training", title: "Parent Training 97156", description: "Which clients are missing parent training, by BCBA and month.", category: "qa", visibleTo: ["super_admin", "operations_leadership", "state_director", "assistant_state_director", "qa_team", "bcba", "clinical_director"], type: "summary", owner: "State Director", lastUpdated: "Live", popularity: 82, aiInsight: "Utilization up 6 points - coaching impact visible.", kpiPreviews: [{ label: "Utilization", value: "77%", delta: "+6pt", trend: "up" }], sparkline: [55, 60, 62, 66, 70, 72, 74, 77], tags: ["97156", "Compliance"] },
  { id: "sd-supervision", title: "Supervision Report", description: "97153 vs 97155 hours, % supervision, below-target clients, BCBA load.", category: "qa", visibleTo: ["super_admin", "operations_leadership", "state_director", "assistant_state_director", "qa_team", "bcba", "clinical_director"], type: "dashboard", owner: "State Director", lastUpdated: "Live", popularity: 80, aiInsight: "6 clients below the 10% supervision threshold this period.", kpiPreviews: [{ label: "Avg %", value: "11.6%", delta: "+0.4pt", trend: "up" }], sparkline: [62, 64, 66, 68, 70, 72, 74], tags: ["Supervision"] },
 ...
 * dashboards. Eleven of the primary reports are shared with every OS role; the
 * two finance reports (claims submission, payment reconciliation) keep their
 * own role restriction, so a role outside their `visibleTo` list sees 20 cards
 * and an eligible finance/leadership role sees up to 22. Legacy REPORTS

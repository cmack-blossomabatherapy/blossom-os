...
export const REPORTS: ReportDef[] = [
  ...
  { id: "qa-supervision-pt", title: "Supervision & Parent Training", description: "Upload a CentralReach billing CSV to instantly review 97153 supervision ratios and 97156 parent training completion by client.", category: "qa", visibleTo: ["super_admin", "operations_leadership", "qa_team", "bcba"], type: "dashboard", owner: "QA Team", lastUpdated: "On upload", popularity: 95, featured: true, aiInsight: "Upload one CR billing export — instantly see supervision % and 97156 gaps by client.", kpiPreviews: [{ label: "97153 hrs", value: "Auto", trend: "up" }, { label: "Supervision %", value: "Auto", trend: "up" }, { label: "97156 gaps", value: "Auto", trend: "down" }], sparkline: [40, 48, 52, 60, 58, 64, 70, 74, 78], tags: ["97153", "97155", "97156", "Supervision", "Parent Training"] },
  { id: "qa-auth-utilization", title: "Authorization Utilization", description: "Upload a CentralReach authorization export and instantly identify utilization risks, expiring auths, exhausted auths, and client authorization health.", category: "qa", visibleTo: ["super_admin", "operations_leadership", "qa_team", "authorization_coordinator", "state_director"], type: "dashboard", owner: "QA Team", lastUpdated: "On upload", popularity: 94, featured: true, aiInsight: "Upload one CR auth export — instantly see utilization risks and expirations by client.", kpiPreviews: [{ label: "Avg Util %", value: "Auto", trend: "up" }, { label: "Exp <30d", value: "Auto", trend: "down" }, { label: "Over-util", value: "Auto", trend: "down" }], sparkline: [42, 48, 55, 60, 65, 68, 72, 76, 80], tags: ["Authorization", "Utilization", "Expiration", "Risk"] },
  { id: "qa-cancellation", title: "Session Cancellation Dashboard", description: "Upload a CentralReach Scheduling Cancellation export and instantly analyze cancellation trends, reasons, provider impacts and client attendance risks.", category: "qa", visibleTo: ["super_admin", "operations_leadership", "qa_team", "state_director", "scheduling_team"], type: "dashboard", owner: "QA Team", lastUpdated: "On upload", popularity: 93, featured: true, aiInsight: "Upload one CR cancellation export — instantly see top reasons, provider impact and at-risk clients.", kpiPreviews: [{ label: "Total cancels", value: "Auto", trend: "down" }, { label: "Provider %", value: "Auto", trend: "down" }, { label: "No shows", value: "Auto", trend: "down" }], sparkline: [60, 58, 62, 55, 50, 48, 52, 46, 42], tags: ["Cancellation", "Attendance", "No Show", "Scheduling"] },

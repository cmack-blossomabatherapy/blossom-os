...
export const WORKSPACES: Workspace[] = [
  ...
  },
  {
    ...
    tabs: [
      ...
      { label: "Treatment Plans",   path: tab("/qa", "treatment-plans") },
      { label: "Progress Reports",  path: tab("/qa", "progress-reports") },
      { label: "Missing Info",      path: tab("/qa", "missing-info") },
      { label: "Compliance",        path: tab("/qa", "compliance") },
  ...
  },
  {
    ...
    tabs: [
      ...
      { label: "Pipeline",       path: "/recruiting/pipeline" },
      { label: "Interviews",     path: "/recruiting/interviews" },
      { label: "Offers",         path: "/recruiting/offers" },
      { label: "Background",     path: "/recruiting/background" },
      { label: "Orientation",    path: "/recruiting/orientation" },
      { label: "Staffing Needs", path: "/recruiting/staffing-needs" },
      { label: "Performance",    path: "/recruiting/performance" },

...
export const SUPER_ADMIN_MENU: SuperAdminNavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Initial → Treatment Handoff",  to: "/authorizations/handoff",             icon: ShieldCheck },
      { label: "CentralReach Handoff Queue",   to: "/authorizations/handoff?queue=centralreach", icon: UploadCloud },

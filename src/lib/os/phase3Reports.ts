...
export const PHASE3_REPORTS: Phase3Report[] = [
  ...
  { id: "bd-referral-sources", name: "Business Development Referral Sources", description: "Referral partner activity, volume, and conversion.", department: "Business Development", lastUpdated: "Not connected", status: "setup_needed", section: "growth", visibleTo: ROLES.bizdev },
  { id: "bd-outreach-followup", name: "Outreach Follow-Up", description: "Open referral partner follow-ups and outreach status.", department: "Business Development", lastUpdated: "Not connected", status: "setup_needed", section: "growth", visibleTo: ROLES.bizdev },
  { id: "bd-referral-conversion", name: "Referral Source Conversion", description: "How referral partners convert into active clients.", department: "Business Development", lastUpdated: "Not connected", status: "setup_needed", section: "growth", visibleTo: ROLES.bizdev },
  { id: "lead-to-active", name: "Lead To Active Conversion", description: "Conversion from initial lead to active client, by source and state.", department: "Intake", lastUpdated: "Not connected", status: "setup_needed", section: "growth", visibleTo: [...ROLES.intake, ...ROLES.exec, ...ROLES.marketing] as OSRole[] },
  ...
  { id: "new-referral-queue", name: "New Referral Queue", description: "New referrals awaiting first contact.", department: "Intake", lastUpdated: "Not connected", status: "setup_needed", section: "growth", visibleTo: ROLES.intake },
  { id: "missing-information", name: "Missing Information", description: "Leads and intakes blocked by missing information.", department: "Intake", lastUpdated: "Not connected", status: "setup_needed", section: "growth", visibleTo: ROLES.intake },
  ...
  { id: "no-oon-benefits", name: "No OON Benefits", description: "Verified VOBs that returned no out-of-network benefits.", department: "Intake", lastUpdated: "Not connected", status: "setup_needed", section: "growth", visibleTo: ROLES.intake },

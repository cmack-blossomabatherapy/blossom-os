...
export type Phase3Status = "live" | "coming_soon" | "needs_data";
...
export const PHASE3_REPORTS: Phase3Report[] = [
  ...
  { id: "patient-journey-touchpoints", name: "Patient Journey Touchpoints", description: "Every touchpoint from first contact through active care.", department: "Marketing", lastUpdated: "Coming soon", status: "coming_soon", section: "growth", visibleTo: ROLES.marketing },
  { id: "bd-referral-sources", name: "Business Development Referral Sources", description: "Referral partner activity, volume, and conversion.", department: "Business Development", lastUpdated: "Coming soon", status: "coming_soon", section: "growth", visibleTo: ROLES.bizdev },
  { id: "bd-outreach-followup", name: "Outreach Follow-Up", description: "Open referral partner follow-ups and outreach status.", department: "Business Development", lastUpdated: "Coming soon", status: "coming_soon", section: "growth", visibleTo: ROLES.bizdev },
  { id: "bd-referral-conversion", name: "Referral Source Conversion", description: "How referral partners convert into active clients.", department: "Business Development", lastUpdated: "Coming soon", status: "coming_soon", section: "growth", visibleTo: ROLES.bizdev },
  { id: "lead-to-active", name: "Lead To Active Conversion", description: "Conversion from initial lead to active client, by source and state.", department: "Intake", lastUpdated: "Coming soon", status: "coming_soon", section: "growth", visibleTo: [...ROLES.intake, ...ROLES.exec, ...ROLES.marketing] as OSRole[] },
  { id: "intake-pipeline", name: "Intake Pipeline", description: "Live view of leads moving through the intake pipeline.", department: "Intake", lastUpdated: "Coming soon", status: "coming_soon", section: "growth", visibleTo: ROLES.intake },
  { id: "new-referral-queue", name: "New Referral Queue", description: "New referrals awaiting first contact.", department: "Intake", lastUpdated: "Coming soon", status: "coming_soon", section: "growth", visibleTo: ROLES.intake },
  { id: "missing-information", name: "Missing Information", description: "Leads and intakes blocked by missing information.", department: "Intake", lastUpdated: "Coming soon", status: "coming_soon", section: "growth", visibleTo: ROLES.intake },
  { id: "intake-followup", name: "Intake Follow-Up", description: "Open intake follow-ups and contact attempts.", department: "Intake", lastUpdated: "Coming soon", status: "coming_soon", section: "growth", visibleTo: ROLES.intake },
  ...
  { id: "expiring-authorizations", name: "Expiring Authorizations", description: "Authorizations expiring in the next 30 / 60 / 90 days.", department: "Authorizations", lastUpdated: "Coming soon", status: "coming_soon", section: "operations", visibleTo: ROLES.auth },
  { id: "missing-docs", name: "Missing Docs", description: "Documents required to submit or maintain authorizations.", department: "Authorizations", lastUpdated: "Coming soon", status: "coming_soon", section: "operations", visibleTo: ROLES.auth },
  { id: "staffing-needs", name: "Staffing Needs", description: "Open clients awaiting staffing by state and service.", department: "Staffing", lastUpdated: "Coming soon", status: "coming_soon", section: "operations", visibleTo: [...ROLES.staffing, ...ROLES.stateDir] as OSRole[] },
...
export function reportRoute(report: Phase3Report): string {
  ...
  return `/coming-soon?module=${encodeURIComponent(report.name + " Report")}`;
}

    ...
    sections: [
      {
        id: "ops_command", label: "Operations Command", items: [
          ...
          { label: "State Health",               path: "/state-operations",              icon: MapPin },
          { label: "Intake Pipeline Visibility", path: "/intake/lead-to-active",         icon: TrendingUp },
    ...
    sections: [
      {
        id: "state_ops", label: "State Operations", items: [
          ...
          { label: "State Pipeline",                 path: "/intake/lead-to-active",        icon: TrendingUp },
    ...
    sections: [
      {
        id: "intake", label: "Intake", items: [
          ...
          { label: "Reports",                    path: "/reports?category=intake",       icon: BarChart3 },
        ],
      },
      TRAINING_AND_RESOURCES,
    ],
    ...
    sections: [
      {
        id: "authorizations", label: "Authorizations", items: [
          ...
          { label: "Reports",                     path: "/reports?category=authorizations",         icon: BarChart3 },
        ],
      },
      TRAINING_AND_RESOURCES,
    ],
    ...
    sections: [
      {
        id: "scheduling", label: "Scheduling", items: [
          ...
          { label: "Reports",                    path: "/reports?category=scheduling",                   icon: BarChart3 },
        ],
      },
      TRAINING_AND_RESOURCES,
    ],
    ...
    sections: [
      {
        id: "staffing", label: "Staffing", items: [
          ...
          { label: "Reports",                     path: "/reports?category=staffing",           icon: BarChart3 },
        ],
      },
      TRAINING_AND_RESOURCES,
    ],

    ...
    sections: [
      {
        id: "recruiting", label: "Recruiting", items: [
          ...
          { label: "Job Postings",                  path: "/recruiting/jobs",            icon: Briefcase },
          { label: "RBT Recruiting",                path: "/recruiting/rbt",             icon: UserCheck },
          { label: "BCBA Recruiting",               path: "/recruiting/bcba",            icon: Stethoscope },
         { label: "Office Staff Recruiting",       path: "/recruiting/office-staff",    icon: Briefcase },
         { label: "Clinic Staff Recruiting",       path: "/recruiting/clinic-staff",    icon: Building2 },
          ...
          { label: "Orientation Queue",             path: "/recruiting/orientation",     icon: ClipboardList },
          ...
          { label: "Escalations",                   path: "/recruiting/escalations",     icon: AlertTriangle },
          { label: "Recruiting Resources",          path: "/recruiting/resources",       icon: BookOpen },
    ...
    sections: [
      {
        id: "staffing", label: "Staffing", items: [
          ...
          { label: "Availability",                path: "/ops/staffing?tab=coverage",           icon: Calendar },
          { label: "Restaffing",                  path: "/ops/staffing?tab=open-cases",         icon: Workflow },
          { label: "Capacity by State",           path: "/ops/staffing?tab=map",                icon: MapPin },
          { label: "Staffing Risk",               path: "/ops/staffing?tab=coverage",           icon: AlertTriangle },
        ],
      },
      TRAINING_AND_RESOURCES,
    ],
    ...
    sections: [
      {
        id: "hr_command", label: "HR Command", items: [
          ...
          { label: "Requests",                 path: "/hr/requests",                 icon: Inbox },
          { label: "Evaluations",              path: "/hr/evaluations",              icon: ClipboardCheck },
          { label: "Messages",                 path: "/hr/messages",                 icon: MessageSquare },
          { label: "Team Resources",           path: "/hr/team-resources",           icon: BookOpen },
          { label: "Device Requests",          path: "/device-requests",             icon: Plug },
          { label: "Device Inventory",         path: "/device-inventory",            icon: List },
    ...
    sections: [
      {
        id: "clinical_leadership", label: "Clinical Leadership", items: [
          ...
          { label: "Treatment Plan Reviews",       path: "/treatment-plan-reviews",  icon: ClipboardCheck },
          { label: "Progress Reports",             path: "/progress-reports",        icon: ClipboardList },

    ...
    sections: [
      {
        id: "ops_command", label: "Operations Command", items: [
          ...
          { label: "State Health",               path: "/state-operations",              icon: MapPin },
          { label: "Intake Pipeline Visibility", path: "/leads?view=pipeline",         icon: TrendingUp },
    ...
    sections: [
      {
        id: "state_ops", label: "State Operations", items: [
          ...
          { label: "State Pipeline",                 path: "/leads?view=pipeline",        icon: TrendingUp },
    ...
    sections: [
      {
        id: "state_support", label: "State Support", items: [
          ...
          { label: "State Pipeline Support",    path: "/leads?view=pipeline",         icon: TrendingUp },
    ...
    sections: [
      {
        id: "regional", label: "Regional Oversight", items: [
          ...
          { label: "State Escalations",            path: "/ops/state-escalations",                  icon: AlertTriangle },
          { label: "Pipeline Aging by State",      path: "/leads?view=pipeline",                  icon: TrendingUp },
    ...
    sections: [
      {
        id: "intake", label: "Intake", items: [
          ...
          { label: "Lead-to-Ready Pipeline",     path: "/leads?view=pipeline",         icon: TrendingUp },

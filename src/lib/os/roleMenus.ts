import {
  ...
  FileCheck2, Clock, Eye, Flame, Library, UserPlus, Bell, List, Sparkles,
} from "lucide-react";
    ...
    sections: [
      {
        id: "staffing", label: "Staffing", items: [
          { label: "Staffing Dashboard",          path: "/ops/staffing?tab=dashboard",     icon: LayoutDashboard },
    ...
    sections: [
      {
        id: "behavioral_support", label: "Behavioral Support", items: [
          ...
          { label: "Behavior Escalations",         path: "/escalations-followups",         icon: Flame },

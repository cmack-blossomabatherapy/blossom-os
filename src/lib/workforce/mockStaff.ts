...
export function buildRbts(state: string): RBT[] {
  ...
  return [
    ...
    { id: "r6", state, name: "Liam Garcia", region: r[1], bcba: "Jordan Lee, BCBA",
      ...
      attendanceConcerns: 0, onboarding: "complete" },
    { id: "r7", state, name: "Zara Malik", region: r[2], bcba: "Camila Ortiz, BCBA",
      clients: 3, scheduledHours: 30, targetHours: 32, utilization: 94,
      trainingComplete: 100, supervisionDue: false, status: "Healthy",
      upcoming: [{ day: "Mon", client: "R. Patel", hours: 4 }, { day: "Thu", client: "D. Foster", hours: 3 }],
      attendanceConcerns: 0, onboarding: "complete" },
    { id: "r8", state, name: "Omar Hassan", region: r[3], bcba: "Marcus Hill, BCBA",
      clients: 2, scheduledHours: 20, targetHours: 30, utilization: 67,
      trainingComplete: 80, supervisionDue: true, status: "Needs Support",
      upcoming: [{ day: "Tue", client: "K. Wallace", hours: 3 }],
      attendanceConcerns: 1, onboarding: "complete" },
    { id: "r9", state, name: "Chloe Brennan", region: r[0], bcba: "Priya Shah, BCBA",
      clients: 2, scheduledHours: 16, targetHours: 30, utilization: 53,
      trainingComplete: 90, supervisionDue: false, status: "Underutilized",
      upcoming: [{ day: "Fri", client: "I. Khan", hours: 3 }],
      attendanceConcerns: 0, onboarding: "complete" },
    { id: "r10", state, name: "Darius Cole", region: r[1], bcba: "Jordan Lee, BCBA",
      clients: 3, scheduledHours: 28, targetHours: 30, utilization: 93,
      trainingComplete: 100, supervisionDue: false, status: "Healthy",
      upcoming: [{ day: "Mon", client: "M. Brooks", hours: 4 }, { day: "Wed", client: "E. Tran", hours: 3 }],
      attendanceConcerns: 0, onboarding: "complete" },
  ];
}
